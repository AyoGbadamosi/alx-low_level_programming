0. Program that assign a random number to the variable n each time it is executed ,with the output showing either n is positive, n is zero or n is negative.
